...
<html lang="fr">
	...
	<body>
		...
		<div id="header">
			<div class="title">
				<u>
					<h1 align="center">Analyse des données</h1>			
				</u>
			</div>
		</div>
...
<div id="tab">
	...
	<table id="tableauGeneral" border="2">
		...
		<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
			<tr>
			<td></td>
			<th class="mdl-data-table__cell--non-numeric"> Temps Moyen selon chemin</th>
			<th class="mdl-data-table__cell--non-numeric"> Temps Moyen des Femmes selon le chemin</th>
			<th class="mdl-data-table__cell--non-numeric"> Temps Moyen des Hommes selon le chemin</th>
			</tr>
		   <tr>
			   <th class="mdl-data-table__cell--non-numeric">Temps Moyen Facile</th>
			   <td align="center"><?php echo($TempsMoy0) ?></td>
			   <td align="center"><?php echo($TempsMoyF0) ?></td>
			   <td align="center"><?php echo($TempsMoyH0) ?></td>
		   </tr>
		   <tr>
			   <th class="mdl-data-table__cell--non-numeric">Temps Moyen Facile-Difficile</th>
			   <td align="center"><?php echo($TempsMoy1) ?></td>
			   <td align="center"><?php echo($TempsMoyF1) ?></td>
			   <td align="center"><?php echo($TempsMoyH1) ?></td>
		   </tr>
		   <tr>
			   <th class="mdl-data-table__cell--non-numeric">Temps Moyen Difficile-Facile</th>
			   <td align="center"><?php echo($TempsMoy2) ?></td>
			   <td align="center"><?php echo($TempsMoyF2) ?></td>
			   <td align="center"><?php echo($TempsMoyH2) ?></td>
		   </tr>
		   <tr>
			   <th class="mdl-data-table__cell--non-numeric">Temps Moyen Difficile</th>
	...
	<br>
	 ...
	 <table id="tableauQuestion&Chemin" border="2">
		<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
		<tr>
		<th class="mdl-data-table__cell--non-numeric"> Temps Moyen en fonction <br /> de la question et du chemin </th>
		<th class="mdl-data-table__cell--non-numeric"> Chemin facile </th>
		<th class="mdl-data-table__cell--non-numeric"> Chemin facile / difficile </th>
		<th class="mdl-data-table__cell--non-numeric"> Chemin difficile / facile </th>
		<th class="mdl-data-table__cell--non-numeric"> Chemin difficile </td>
		</tr>
	   <tr>
		<?php
	...
	?>
		   <th class="mdl-data-table__cell--non-numeric">Question 1</th>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy1Q1) ?></td>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy2Q1) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy3Q1) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy0Q1) ?></td>
	   </tr>
	   <tr>
		<?php
	...
	?>
		   <th class="mdl-data-table__cell--non-numeric">Question 2</th>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy1Q2) ?></td>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy2Q2) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy3Q2) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy0Q2) ?></td>
	   </tr>
	   <tr>
		<?php
	...
	?>
		   <th class="mdl-data-table__cell--non-numeric">Question 3</th>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy1Q3) ?></td>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy2Q3) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy3Q3) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy0Q3) ?></td>
	   </tr>
	   <tr>
		<?php
	...
	?>
		   <th class="mdl-data-table__cell--non-numeric">Question 4</th>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy1Q4) ?></td>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy2Q4) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy3Q4) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy0Q4) ?></td>
	   </tr>   
	   <tr>
		<?php
	...
	?>
		   <th class="mdl-data-table__cell--non-numeric">Question 5</th>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy1Q5) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy2Q5) ?></td>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy3Q5) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy0Q5) ?></td>
	   </tr>   
	   <tr>
		<?php
	...
	?>
		   <th class="mdl-data-table__cell--non-numeric">Question 6</th>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy1Q6) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy2Q6) ?></td>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy3Q6) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy0Q6) ?></td>
	   </tr>
	   <tr>
		<?php
	...
	?>
		   <th class="mdl-data-table__cell--non-numeric">Question 7</th>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy1Q7) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy2Q7) ?></td>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy3Q7) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy0Q7) ?></td>
	   </tr>
	   <tr>
		<?php
	...
	?>
		   <th class="mdl-data-table__cell--non-numeric">Question 8</th>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy1Q8) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy2Q8) ?></td>
		   <td bgcolor="#0AB7B7" align="center"><?php echo($TempsMoy3Q8) ?></td>
		   <td bgcolor="#FD3A47" align="center"><?php echo($TempsMoy0Q8) ?></td>
	   </tr>
	</table>
		   <table width=10% border=1>
			   <center>
				<td bgcolor="#0AB7B7" align="center"> Facile    </td>
				<td bgcolor="#FD3A47" align="center"> Difficile </td>
			</center>
		   </table>
</table> 
	  ...
	  <table id="tableauQuestionGeneral" border="2">
		<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">	
		<th class="mdl-data-table__cell--non-numeric"> Temps Moyen sur question</th>
		<th class="mdl-data-table__cell--non-numeric"> Temps réponse moyen sur la question</th>
	   <tr>
		<?php
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 1 (Q1 : difficile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 2 (Q1 : facile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 3 (Q2 : difficile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 4 (Q2 : facile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 5 (Q3 : difficile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 6 (Q3 : facile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 7 (Q4 : difficile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 8 (Q4 : facile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 9 (Q5 : difficile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 10 (Q5 : facile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 11 (Q6 : difficile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 12 (Q6 : facile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 13 (Q7 : difficile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 14 (Q7 : facile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 15 (Q8 : difficile)</th>
	   ...
	   <tr>
		...
		?>
		   <th class="mdl-data-table__cell--non-numeric">Question 16 (Q8 : facile)</th>
